...
public class HomeFragment extends Fragment implements ProductAdapter.OnProductClickListener {
    ...
    private void loadDemoCategories() {
        ...
        demoCategories.add(createCategory(1L, "Điện thoại"));
        demoCategories.add(createCategory(2L, "Laptop"));
        demoCategories.add(createCategory(3L, "Tablet"));
        demoCategories.add(createCategory(4L, "Phụ kiện"));
        demoCategories.add(createCategory(5L, "Đồng hồ"));
        demoCategories.add(createCategory(6L, "Âm thanh"));
        categoryAdapter.updateData(demoCategories);
    }
    ...
    private void loadDemoProducts() {
        ...
        demoProducts.add(createProduct(2L, "Samsung Galaxy S24 Ultra", 31990000.0, 35990000.0, 15));
        demoProducts.add(createProduct(3L, "MacBook Pro M3 14 inch", 49990000.0, null, 5));
        demoProducts.add(createProduct(4L, "iPad Pro M2 12.9 inch", 28990000.0, 32990000.0, 8));
        demoProducts.add(createProduct(5L, "Apple Watch Series 9", 10990000.0, 12990000.0, 20));
        demoProducts.add(createProduct(6L, "AirPods Pro 2", 5990000.0, 6990000.0, 30));
        productAdapter.updateData(demoProducts);
    }
