...
import com.example.ute.activities.FavoritesActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private LinearLayout btnOrderHistory, btnOrderTracking;
    private LinearLayout btnFavorites, btnHelp, btnAbout;
    ...
    private void initViews(View view) {
        ...
        btnOrderTracking = view.findViewById(R.id.btnOrderTracking);
