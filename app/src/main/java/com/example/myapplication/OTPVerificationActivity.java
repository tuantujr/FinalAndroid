...
public class OTPVerificationActivity extends AppCompatActivity {
    ...
    private void handleVerifyOTP() {
        ...
        // Simulate OTP verification success, then register
        performRegister();
    }

    private void performRegister() {
        RegisterRequest request = new RegisterRequest(userName, userUsername, userEmail, userPassword);
        RetrofitClient.getApiService().register(request).enqueue(new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(OTPVerificationActivity.this, "Registration Failed: " + response.message(), Toast.LENGTH_SHORT).show();
                }
            }
