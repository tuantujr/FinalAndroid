...
public class VoucherRepository {
    ...
    public Optional<Voucher> findByCode(String code) {
        ...
        try {
            ...
            voucher.setOrders(new java.util.ArrayList<>());
    ...
    public List<Voucher> findAll() {
        ...
        try {
            List<Voucher> vouchers = em.createQuery(
                ...
                .getResultList();
            // Clear lazy-loaded collections to avoid serialization issues with Hibernate proxies
            for (Voucher voucher : vouchers) {
                // Clear the orders collection to prevent GSON serialization errors
                voucher.setOrders(new java.util.ArrayList<>());
            }
            return vouchers;
        } finally {
